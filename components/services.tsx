        ...
        <div className="grid grid-cols-1 gap-px bg-[#1A1A1A]/10 border border-[#1A1A1A]/10">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-8 md:gap-16 items-start">
              <div className="w-12 h-12 flex items-center justify-center border border-[#1A1A1A]/10 rounded-full shrink-0 text-[#C59D5F] group-hover:border-[#C59D5F]/30 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#1A1A1A]/10">
            ...
            >
              ...
              <span className="inline-flex items-center text-sm text-[#1A1A1A] font-medium group-hover:text-[#C59D5F] transition-colors">
                選購商品 <ArrowRight className="ml-1 w-4 h-4" />
              </span>
            </Link>
            ...
            <Link 
              ...
              className="block bg-[#F5F5F0] p-10 md:p-12 hover:bg-[#F9F9F7] transition-all duration-300 group cursor-pointer"
            >
              <BarChart3 className="w-8 h-8 text-[#1A1A1A]/40 mb-8 group-hover:text-[#C59D5F]/60 transition-colors" strokeWidth={1} />
