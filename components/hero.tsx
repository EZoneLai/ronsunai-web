        ...
        <div className="md:col-span-4 order-2 md:order-1 flex justify-center md:justify-start">
          <div className="flex gap-8 md:gap-12 h-[60vh] md:h-[50vh] items-start select-none">
            ...
            <div className="flex flex-row gap-8 items-start">
              <h1 className="writing-vertical-rl text-4xl md:text-6xl text-[#C59D5F] tracking-[0.2em] leading-relaxed font-semibold whitespace-nowrap" style={{ fontFamily: `'Noto Serif TC', 'Songti TC', 'Source Han Serif TC', 'serif'` }}>
                以古智定心
              </h1>
              <h1 className="writing-vertical-rl text-4xl md:text-6xl text-[#1A1A1A] tracking-[0.2em] leading-relaxed font-medium whitespace-nowrap" style={{ fontFamily: `'Noto Serif TC', 'Songti TC', 'Source Han Serif TC', 'serif'` }}>
                用科技賦能
              </h1>
            </div>
          </div>
